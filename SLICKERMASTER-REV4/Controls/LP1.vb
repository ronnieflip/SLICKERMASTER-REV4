...
Public NotInheritable Class LP1
    Inherits PictureBox
    ' Methods
    Public Sub New()
    ...
    Public Sub WRT(ByVal ParamArray A As Object())
        Dim pp2 As LP1 = Me
        SyncLock pp2
            Me.Lines.Insert(Me.Lines.Count, A)
            If (Me.Lines.Count = 150) Then
                Me.Lines.RemoveAt(0)
            End If
        End SyncLock
    End Sub
